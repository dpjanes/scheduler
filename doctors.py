...
constraints.constraint_no_more_than_once_in_n_days(scheduler, N=7, dates=scheduler.xweekdays)
...
constraints.constraint_equal_work_distribution(scheduler, tolerance=2, dates=scheduler.xweekdays)
constraints.constraint_equal_work_distribution(scheduler, tolerance=2, dates=scheduler.xweekends)
# constraints.constraint_weekend_pairing(scheduler, penalty_weight=100)
constraints.constraint_long_weekend_triplet(scheduler, penalty_weight=100)
